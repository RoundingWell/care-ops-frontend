...
It will automatically create a tagged release on origin tagged by `v1-release-YYMMDD`
If that release tag already exists it will increment the tag ie: `v1-release-YYMMDD-1`
...
This will create the tag `v1-test-foo`
